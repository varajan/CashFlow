...
CREATE TABLE IF NOT EXISTS Persons (ID Number, Profession Text, Salary Number, Cash Number, SmallRealEstate Number, ReadyForBigCircle Number, BigCircle Number, InitialCashFlow Number, Bankruptcy Number, CreditsReduced Number);
