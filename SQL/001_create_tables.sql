...
CREATE TABLE IF NOT EXISTS Persons (ID Number, Profession Text, Salary Number, Cash Number, SmallRealEstate Number, ReadyForBigCircle Number, BigCircle Number, InitialCashFlow Number);
...
CREATE TABLE IF NOT EXISTS AvailableAssets (Type Number, Value Text);
