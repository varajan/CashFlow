...
CREATE TABLE IF NOT EXISTS DefaultPersonData (ID Number, Salary Number, Cash Number, Taxes Number, Mortgage Number, SchoolLoan Number, CarLoan Number, CreditCard Number, Others Number, PerChild Number, SmallCredits Number, Mortgage Number, SchoolLoan Number, CarLoan Number, CreditCard Number, SmallCredits Number);
DELETE FROM Terms;
