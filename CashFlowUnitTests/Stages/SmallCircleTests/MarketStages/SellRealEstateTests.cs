...
public class SellRealEstateTests : SellAssetBaseTest
{
    ...
    public void SellRealEstate_Question_and_Buttons()
    {
        ...
        var message = $"What Real Estate do you want to sell?{NL}*#1* RealEstate No1 Text{NL}*#2* RealEstate No2 Text{NL}*#3* RealEstate No3 Text";
    ...
    public async Task SellRealEstate_SelectInvalidOption_StayOnStage([Values("0", "#4")] string option)
    {
        ...
        NotifyServiceMock.Verify(n => n.Notify(CurrentUser.Id, "Invalid Real Estate number."), Times.Once);
    ...
    protected override IStage GetTestStage() => GetStage<SellRealEstate>();
}
