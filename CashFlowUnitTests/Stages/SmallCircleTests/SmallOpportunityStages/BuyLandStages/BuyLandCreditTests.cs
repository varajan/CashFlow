...
public class BuyLandCreditTests : StagesBaseTest
{
    ...
    private AssetDto Asset => new() { Id = 123, UserId = CurrentUser.Id, Price = 500, Qtty = 1, Type = AssetType.Land, IsDraft = true };
    ...
    public async Task BuyLandCredit_ToBank_Confirmed_IsCompleted()
    {
        ...
        PersonServiceMock.Verify(x => x.AddHistory(ActionType.BuyLand, Asset.Qtty, CurrentUser, Asset.Id), Times.Once);
