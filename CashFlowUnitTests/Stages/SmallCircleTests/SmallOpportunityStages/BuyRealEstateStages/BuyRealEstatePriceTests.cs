...
namespace CashFlowUnitTests.Stages.SmallCircleTests.SmallOpportunityStages.BuyRealEstateStages;

[TestFixture]
public class BuyRealEstatePriceTests : StagesBaseTest
{
    private static readonly string[] Prices = CashFlow.Data.Consts.Prices.RealEstateSmallBuyPrice.AsCurrency().ToArray();
    ...
    protected override IStage GetTestStage() => GetStage<BuySmallRealEstatePrice>();
}
