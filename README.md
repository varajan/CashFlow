...
- `CashFlow-2.0.8-ba-linux-x64.zip` → `CashFlow`
- `CashFlow-2.0.8-ba-osx-x64.zip` → `CashFlow`
- `CashFlow-2.0.8-ba-win-x64.zip` → `CashFlow.exe`
- `CashFlow-2.0.8-ba-win-x86.zip` → `CashFlow.exe`
