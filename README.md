...
- [CashFlow-2.0.9-beta-linux-x64.zip](https://github.com/varajan/CashFlow/releases/download/v2.0.9-beta/CashFlow-2.0.9-beta-linux-x64.zip) → `CashFlow`
- [CashFlow-2.0.9-beta-osx-x64.zip](https://github.com/varajan/CashFlow/releases/download/v2.0.9-beta/CashFlow-2.0.9-beta-osx-x64.zip) → `CashFlow`
- [CashFlow-2.0.9-beta-win-x64.zip](https://github.com/varajan/CashFlow/releases/download/v2.0.9-beta/CashFlow-2.0.9-beta-win-x64.zip) → `CashFlow.exe`
- [CashFlow-2.0.9-beta-win-x86.zip](https://github.com/varajan/CashFlow/releases/download/v2.0.9-beta/CashFlow-2.0.9-beta-win-x86.zip) → `CashFlow.exe`
