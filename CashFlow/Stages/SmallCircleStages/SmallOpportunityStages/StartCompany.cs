...
public class StartCompanyPrice(ITranslationService termsService, IUserService userService, IPersonService personManager, IUserRepository userRepository)
    : BuyAssetPrice<StartCompanyCredit>(BuyPrice.BusinessSmall, AssetType.SmallBusinessType, ActionType.StartCompany, termsService, userService, personManager, userRepository)
{ }
