    ...
    : BuyAsset<TNextStage>(assetName, assetType, termsService, availableAssets, personManager, userRepository) where TNextStage : BaseStage
{
    public override string Message
    {
        get
        {
            ...
            return Terms.Get("You don''t have {0}, but only {1}", CurrentUser, amount.AsCurrency(), person.Cash.AsCurrency());
        }
    }
    ...
    public override async Task HandleMessage(string message)
    {
        ...
        switch (message)
        {
            ...
            case var m when MessageEquals(m, "Get Credit"):
                ...
                await CurrentUser.Notify(Terms.Get("You've taken {0} from bank.", CurrentUser, credit.AsCurrency()));
