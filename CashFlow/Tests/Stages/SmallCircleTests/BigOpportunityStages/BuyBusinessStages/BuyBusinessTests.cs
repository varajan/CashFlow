...
public class BuyBusinessTests : StagesBaseTest
{
    ...
    [Test]
    public async Task BuyBusiness_SelectInvalidName_StayOnStage()
    {
        // Arrange
        var testStage = GetTestStage();
    ...
    public async Task BuyBusiness_SelectValidName_MoveForward(string title)
    {
        // Arrange
        var testStage = GetTestStage();
    ...
    protected override IStage GetTestStage() => new BuyBusiness(TermsServiceMock.Object, AvailableAssetsMock.Object, AssetManagerMock.Object)
